			...
			<main class="main">
				...
				<form action="list" method="post">
								...
								<c:forEach items="${list}" var="n">
									<tr>
										...
										<td class="title indent text-align-left"><a
											href="detail?id=${n.cd}"> ${n.title} [${n.reCnt}]</a></td>
										<td>${n.userCd}</td>
										<td><fmt:formatDate pattern="yy-MM-dd"
												value="${n.createdDt}"></fmt:formatDate></td>
										<td>${n.likeCnt}</td>
										<td><input type="checkbox" name="openId" value="${n.cd}"></td>
										<td><input type="checkbox" name="delId" value="${n.cd}"></td>
									</tr>
								</c:forEach>
					...
					<div class="text-align-right margin-top">
						<input type="submit" name ="cmd" class="btn-text btn-default" value="일괄공개">
						<input type="submit" name ="cmd" class="btn-text btn-default" value="일괄삭제">
<!-- 						다중 submit이므로 controller에서 구분해야 함 -->
