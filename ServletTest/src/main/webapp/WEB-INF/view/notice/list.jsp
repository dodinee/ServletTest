<%@page import="com.temp.web.Entity.Notice"%>
					...
					<form class="table-form">
						<fieldset>
							...
							<label class="hidden">검색분류</label> <select name="f">
								...
								<option ${param.f == "title" ? "selected" : ""} value="user_cd">작성자</option>
					...
					<table class="table">
						...
						<tbody>
							...
							<c:forEach items="${list}" var="n">
								...
								<!-- begin부터 end까지만 반복 st에 다양한 속성 사용 가능 ex) st.begin st.first st.index ... -->

								<tr>
									<td>${n.cd}</td>
									<td class="title indent text-align-left"><a
										href="detail?id=${n.cd}"> ${n.title} [${n.reCnt}]</a></td>
									<!-- detail.jsp?id= 가 아닌 컨트롤러의 주소 detail로 변경되어야함  -->
									<td>${n.userCd}</td>
